...
/*
	...
	while ( (curColor = [enumerator nextObject]) != nil ) {
		...
		float r = [curColor[0] intValue]/255.0f;
        float g = [curColor[1] intValue]/255.0f;
        float b = [curColor[2] intValue]/255.0f;
    ...
    return [UIColor colorWithRed:r2 green:g2 blue:b2 alpha:0.0f];
*/
}
